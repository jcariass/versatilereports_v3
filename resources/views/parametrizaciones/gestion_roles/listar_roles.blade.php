                        ...
                        <div class="card-header">
                            ...
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li>
                                        <a href="https://youtu.be/Jp4bWAMrF20" target="_blank" class="btn btn-gris">
                                            Ayuda en línea
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('crear_roles') }}" class="btn btn-versatile_reports">
                        ...
                        <div class="card-body">
                            <div class="card-content collapse show">
                                ...
                                <div class="table-responsive">
                                    <table id="roles" style="width: 100%;" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Nombre</th>
