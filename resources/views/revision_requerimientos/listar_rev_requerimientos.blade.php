    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title mb-0">Revisión de requerimientos</h3>
                        ...
                        <div class="card-header">
                            ...
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li>
                                        <a href="https://youtu.be/fQUuf8EfqG4" target="_blank" class="btn btn-versatile_reports">
                                            Ayuda en línea
                                        </a>
                                    </li>
...
<script>
    $('#requerimientos').DataTable({
        processing: true,
        serverSide: true,
        ajax: '/revision/requerimientos/listar',
        columns: [
